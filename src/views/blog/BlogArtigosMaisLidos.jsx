...
export default function BlogArtigosMaisLidos() {
  return (
    <div className="container-artigos-mais-lidos-blog">
      <div className="container-artigos-mais-lidos-blog-title" style={{width:'59.09%'}}>
      ...
      >
        <SwiperSlide>
          <BlogCardArtigoMaisVendido
            ...
            legenda={
              "Santa Catarina é um dos melhores estados do Brasil para se viver, e o primeiro quando o assunto é turismo. Ao analisar métricas como educação,"
            }
          />
          <BlogCardArtigoMaisVendido
